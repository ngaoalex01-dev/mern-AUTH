...
<body style="font-family: Arial, sans-serif; background-color: #f4f4f4; padding: 20px;">
  ...
  <div style="max-width: 600px; margin: auto; background: #ffffff; border-radius: 8px; overflow: hidden; box-shadow: 0 2px 6px rgba(0,0,0,0.1);">
    ...
    <div style="background: #4CAF50; padding: 20px; text-align: center;">
      <h2 style="color: #ffffff; margin: 0;">{company}</h2>
    </div>

    <!-- HERO IMAGE -->
    <img src="https://res.cloudinary.com/dxipgbs5g/image/upload/v1775846732/Whatsapp_app_icon_sjtvbh.jpg" alt="Welcome Banner" style="width: 100%; display: block;" />
    ...
    <div style="padding: 20px; color: #333;">
      ...
      <!-- CTA -->
      <div style="text-align: center; margin: 30px 0;">
        <a href="#" style="background-color: #4CAF50; color: #fff; padding: 12px 25px; text-decoration: none; border-radius: 5px; font-weight: bold;">
          Next Step
        </a>
      </div>
      ...
      <div style="margin: 20px 0;">
        ...
        <p>
          ...
          <a href="#" style="text-decoration: none; color: #4CAF50; font-weight: bold;">
